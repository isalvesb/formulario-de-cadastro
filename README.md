...
<h2>📝Visão Geral</h2>
<p>Este projeto consiste em um formulário simples construído com HTML, CSS e Javascript. O objetivo é treinar lógica de programação e demonstrar a estrutura e funcionamento de um formulário interativo com validações básicas e estilos customizados.</p>
...
<div style="background-color:#C69FD4; padding:12px; border-radius:8px;">
...
<div style="background-color:#FDFDC9; padding:12px; border-radius:8px;">
